<%-- 
    ...
    Created on : 20 Apr, 2018, 1:03:00 PM
    Author     : amany
--%>
...
<center>
<font color="white">
<br><br><br><h1>Delete Student</h1>
<form action="dstudent">
  <center>
  <br><br><br><br><br><br>
                <b><font color="LightSalmon" size="50">ID:</font></b>
 <input type="text" name="id" size="20"><br><br>
 <font color="black" ><input type="submit" value="Delete" onclick="alert('Student Record Deleted')"></font><br><br>        
</center>
</form>
</font>
</center>
